...
| --- | --- |
| PHP 8.2 or [above](https://github.com/FusionGen/FusionGEN/blob/main/install/index.php#L23) | (enable Extensions: php_mysqli, php_curl, php_openssl, php_soap, php_mbstring, php_json - core extension, php_zip, php_gd and php_gmp) |
