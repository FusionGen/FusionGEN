    ...
    public function __construct()
    {
        ...
        if(isset($_POST))
		{
            ...
            try {
                ...
                echo json_encode(array("success" => false, "message" => "Char DB: ".$e->getMessage()));
                exit();
	        }
	        ...
	        try {
                ...
                echo json_encode(array("success" => false, "message" => "World DB: ".$e->getMessage()));
                exit();
	        }
            ...
            if(mysqli_query($mysqli_cms, $query))
            {
                ...
                echo json_encode(array("success" => false, "message" => mysqli_error($mysqli_cms))); 
            }
        }
    }
