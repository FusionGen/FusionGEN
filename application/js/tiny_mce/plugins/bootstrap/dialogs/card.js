!(function () {
    ...
    function a() {
        ...
        var s = Array(e),
            i = 0;
        for (t = 0; t < a; t++) for (var r = arguments[t], o = 0, n = r.length; o < n; o++, i++) s[i] = r[o];
        return s;
    }
    var s = (function () {
            function e() {
            ...
            return (
                ...
                (e.prototype.getOriginalAttributes = function (e) {
                    ...
                    for (
                        ...
                        if (((o = l[n]), -1 === i.indexOf(o)))
                            if (this.reservedClassesRegex.length < 1) this.miscClasses.push(o);
                            else
                                for (var d = 0; d < this.reservedClassesRegex.length; d++) {
                                    var h = new RegExp(this.reservedClassesRegex[d], "g");
                                    o.match(h) || this.miscClasses.push(o);
                                }
                    var u = void 0,
                        g = ((n = 0), e.attributes);
                    for (c = g.length; n < c; n++) "class" !== (u = g[n]).nodeName && -1 === s.indexOf(u.nodeName) && (this.miscAttributes[u.nodeName] = u.nodeValue);
                    var p = "";
                    if (
                        (Object.keys(this.elStyles).forEach(function (e) {
                            -1 === r.indexOf(e) && (p += " " + t.reverseCamelize(e) + ":" + t.elStyles[e] + ";");
                        }),
                        p.length > 0)
                    ) {
                ...
                (e.prototype.getIconClass = function (e) {
                    var t = this,
                        ...
                        o = new RegExp(this.bsInstance.iconBaseClasses.join("|"), "g");
                    return (
                        jQuery.each(s, function (e, s) {
                            if (s.match(r)) {
                                var n = !1;
                                if (-1 !== t.reservedIconClasses.indexOf(s) || -1 !== t.reservedClasses.indexOf(s)) n = !0;
                                else
    ...
    new ((function (s) {
        function r() {
            ...
            return (
                (e.bodyHtml = '<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card\'s content.</p>'),
                (e.border = ""),
                (e.color = ""),
                (e.footerHtml = '<p class="mb-0">Card Footer</p>'),
                (e.hasFooter = !0),
                (e.hasHeader = !0),
                (e.hasImage = !1),
                (e.hasImageOverlay = !1),
                (e.headerHtml = '<p class="mb-0">Card Header</p>'),
                (e.imageAlt = ""),
                (e.imageOverlayHtml =
                    '<h5 class="card-title">Card title</h5> <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p> <p class="card-text">Last updated 3 mins ago</p>'),
                (e.imagePosition = "top"),
                (e.imageSource = ""),
                (e.style = "bg-light"),
                (e.textAlignment = ""),
        ...
        return (
            ...
            (r.prototype.init = function () {
                var e = this,
                    ...
                    o = doT.template(r);
                (document.querySelector("body").innerHTML = o(s)),
                    (this.availableBorders = ["border-primary", "border-secondary", "border-success", "border-danger", "border-warning", "border-info", "border-light", "border-dark"]),
                    (this.availableColors = ["text-primary", "text-secondary", "text-success", "text-danger", "text-warning", "text-info", "text-light", "text-dark", "text-white"]),
                    (this.availableStyles = ["bg-primary", "bg-secondary", "bg-success", "bg-danger", "bg-warning", "bg-info", "bg-light", "bg-dark"]),
                    (this.availableTextAlignments = ["text-center", "text-justify", "text-right"]),
                    (this.reservedClasses = a(this.availableBorders, this.availableStyles, this.availableTextAlignments, ["card", "tbp-active"])),
                    ...
                    loadjs.ready("htmlContentEditor", function () {
                        tinymce.init(
                            t(t({ selector: "#header-html-editor" }, i), {
                                setup: function (t) {
                                    t.on("change, keyup", function (a) {
                                        (e.headerHtml = t.getContent()), e.render();
                                    });
                                },
                            })
                        ),
                            tinymce.init(
                                t(t({ selector: "#footer-html-editor" }, i), {
                                    setup: function (t) {
                                        t.on("change, keyup", function (a) {
                                            (e.footerHtml = t.getContent()), e.render();
                                        });
                                    },
                                })
                            ),
                            tinymce.init(
                                t(t({ selector: "#image-overlay-html-editor, #body-html-editor" }, i), {
                                    setup: function (t) {
                                        t.on("change, keyup", function (a) {
                                            var s = t.dom.select("a"),
                                                i = t.dom.select("p"),
                                                r = t.dom.select("h1, h2, h3, h4, h5, h6"),
                                                o = t.dom.select("h1 ~ h2, h2 ~ h3, h3 ~ h4, h4 ~ h5, h5 ~ h6");
                                            s.length > 0 && t.dom.addClass(s, "card-link"),
                                                i.length > 0 && t.dom.addClass(i, "card-text"),
                                                r.length > 0 && t.dom.addClass(r, "card-title"),
                                                o.length > 0 && (t.dom.removeClass(o, "card-title"), t.dom.addClass(t.dom.select("h1 ~ h2, h2 ~ h3, h3 ~ h4, h4 ~ h5, h5 ~ h6"), "card-subtitle"));
                                            var n = t.dom.select("body > :last-child"),
                                                l = t.dom.select("body > :nth-last-child(2)");
                                            l !== n && (t.dom.removeClass(l, "mb-0"), t.dom.addClass(n, "mb-0")), (e.bodyHtml = t.getContent()), e.render();
                                        });
                                    },
                                })
                            );
            ...
            (r.prototype.setPluginMode = function () {
                ...
                e.length > 0 && jQuery(e).hasClass("card") && (this.pluginMode = "replace");
            }),
            (r.prototype.render = function () {
                ...
                (t.class = this.style),
                    ...
                    this.border.length > 0 && (t.class += " " + this.border),
                    this.color.length > 0 && (t.class += " " + this.color),
                    this.textAlignment.length > 0 && (t.class += " " + this.textAlignment),
                    (e = '<div class="card ' + t.class + '"' + t.originalAttributes + ">"),
                    !0 === this.hasHeader && (e += '<div class="card-header">' + this.headerHtml + "</div>"),
                    !0 === this.hasImage &&
                        "top" === this.imagePosition &&
                        ((e += '<img src="' + this.imageSource + '" width="100%" height="auto" class="card-img-top" alt="' + this.imageAlt + '">'),
                        !0 === this.hasImageOverlay && (e += '<div class="card-img-overlay">' + this.imageOverlayHtml + "</div>")),
                    (e += '<div class="card-body">' + this.bodyHtml + "</div>"),
                    !0 === this.hasImage &&
                        "bottom" === this.imagePosition &&
                        ((e += '<img src="' + this.imageSource + '" width="100%" height="auto" class="card-img-top" alt="' + this.imageAlt + '">'), !0 === this.hasImageOverlay && (e += this.imageOverlayHtml)),
                    !0 === this.hasFooter && (e += '<div class="card-footer">' + this.footerHtml + "</div>"),
                    (e += "</div>"),
            ...
            (r.prototype.initEvents = function () {
                var e = this;
                jQuery('input[data-prop="imagePosition"]').on("change keyup", function (e) {
                    "bottom" === jQuery(e.target).val()
                        ? (jQuery('.btn-group button[data-prop="hasImageOverlay"][data-value="false"]').trigger("click"), jQuery('.btn-group button[data-prop="hasImageOverlay"]').attr("disabled", !0))
                        : jQuery('.btn-group button[data-prop="hasImageOverlay"]').removeAttr("disabled");
                }),
                    jQuery('.btn-group button[data-prop="hasImageOverlay"][data-value="true"]').on("click", function (t) {
                        "top" === e.imagePosition && ((e.hasHeader = !1), e.updateDialog("hasHeader", !1, "boolean"));
                    }),
                    jQuery('.btn-group button[data-prop="hasHeader"][data-value="true"]').on("click", function (t) {
                        "top" === e.imagePosition && ((e.hasImageOverlay = !1), e.updateDialog("hasImageOverlay", !1, "boolean"));
                    }),
                    s.prototype.initEvents.call(this),
                    "bottom" === this.imagePosition
                        ? jQuery('.btn-group button[data-prop="hasImageOverlay"]').attr("disabled", !0)
                        : ((this.hasHeader = !1), this.updateDialog("hasHeader", !1, "boolean"), (this.hasImageOverlay = !1), this.updateDialog("hasImageOverlay", !1, "boolean"));
            }),
            (r.prototype.initFileTree = function () {
                var e = this,
                    t = {
                        ...
                        okBtnClick: function (t, a) {
                            e.imageSource = t;
                            var s = new Image();
                            (s.src = e.imageSource),
                                (s.onload = function () {
                                    (e.hasImage = !0), e.updateDialog("hasImage", e.hasImage, "boolean"), e.render();
                                }),
                                jQuery("#file-tree-modal").removeClass("show-modal");
                        },
                    };
                ...
                jQuery(window).on("click", function (e) {
                    ...
                    jQuery("#remove-image-btn").on("click", function () {
                        (e.hasImage = !1), (e.imageSource = ""), (e.imageAlt = ""), e.render();
                    });
            }),
            (r.prototype.setInitialProperties = function (e) {
                ...
                if ("replace" === this.pluginMode) {
                    (this.hasFooter = !1),
                        (this.hasHeader = !1),
                        this.availableBorders.forEach(function (a) {
                            jQuery(e).hasClass(a) && (t.border = a);
                        }),
                        this.availableColors.forEach(function (a) {
                            jQuery(e).hasClass(a) && (t.color = a);
                        });
                    var a = jQuery(e).find(".card-body");
                    a[0] && (this.bodyHtml = a.html());
                    var s = jQuery(e).find(".card-footer");
                    s[0] && ((this.hasFooter = !0), (this.footerHtml = s.html()));
                    var i = jQuery(e).find(".card-header");
                    i[0] && ((this.hasHeader = !0), (this.headerHtml = i.html()));
                    var r = jQuery(e).find(".card-img-top");
                    r[0] &&
                        ((this.hasImage = !0),
                        (this.imageAlt = r.attr("alt")),
                        (this.imageSource = r.prop("src")),
                        jQuery(e).closest(".tbp-active").children(".card-img-top:first-child")[0] ? (this.imagePosition = "top") : (this.imagePosition = "bottom"));
                    var o = jQuery(e).find(".card-img-overlay");
                    o[0] && ((this.hasImageOverlay = !0), (this.imageOverlayHtml = o.html())), this.getOriginalAttributes(e);
                }
                jQuery("#body-html-editor").html(this.bodyHtml),
                    jQuery("#footer-html-editor").html(this.footerHtml),
                    jQuery("#header-html-editor").html(this.headerHtml),
                    jQuery("#image-overlay-html-editor").html(this.imageOverlayHtml),
                    this.updateDialog("hasFooter", this.hasFooter, "boolean"),
                    this.updateDialog("hasHeader", this.hasHeader, "boolean"),
                    this.updateDialog("hasImage", this.hasImage, "boolean"),
                    this.updateDialog("hasImageOverlay", this.hasImageOverlay, "boolean"),
                    this.updateDialog("imagePosition", this.imagePosition, "radio"),
                    this.updateDialog("textAlignment", this.textAlignment, "select"),
                    this.updateDialog("style", this.style, "select"),
                    this.render();
            }),
            r
        );
