...
class Smarty_Template_Cached extends Smarty_Template_Resource_Base
{
    ...
    public static function load(Smarty_Internal_Template $_template)
    {
        ...
        // caching enabled ?
        if (
            !$_template->caching || $_template->source->handler->recompiled
        ) {
    ...
    public function isCached(Smarty_Internal_Template $_template)
    {
        ...
        while (true) {
            while (true) {
                ...
                if (
                    $this->valid && $_template->caching === Smarty::CACHING_LIFETIME_CURRENT
                ...
                if (
                    $this->valid && $_template->compile_check === Smarty::COMPILECHECK_ON
            ...
            if (
                $this->valid && $_template->caching === Smarty::CACHING_LIFETIME_SAVED
