				...
				<tr>
					...
					<td>
						{if $teleport_location.vpCost}
							<img src="{$url}application/assets/images/icons/lightning.png" style="opacity:1;"> {$teleport_location.vpCost} VP
						{elseif $teleport_location.dpCost}
							<img src="{$url}application/assets/images/icons/coins.png" style="opacity:1;">
