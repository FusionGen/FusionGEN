<section class="card">
	...
	<div class="form-group row">
		...
		<div class="col-lg-9">
		<input class="form-control" type="url" name="vote_url" id="vote_url" placeholder="https://" onChange="Topsites.check(this)" value="{$topsite.vote_url}" {if isset($topsite.votelink_format)}data-format="{$topsite.votelink_format}"{/if}>
		</div>
	</div>
	...
	<div class="form-group row mb-3">
		<label class="col-lg-3 col-form-label form-control-label" for="callback_enabled" data-bs-toggle="tooltip" data-bs-placement="top" title="If enabled, vote points are only credited if the user has actually voted. Not all topsites support this feature.">Enable vote verification (<a>?</a>)</label>
		<div class="col-lg-9">
