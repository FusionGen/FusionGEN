	 ...
	 getIcon: function(id, realm)
	 {
	 	if($.inArray(id, this.loadedIcons) == -1)
	 	{
	 		...
	 		$.get(Config.URL + "icon/get/" + realm + "/" + id, function(data)
		 	{
		 		...
		 		{
		 			$(this).html("<div class='item'><a href='" + Config.URL + "item/" + realm + "/" + id + "' rel='item=" + id + "' data-realm='" + realm + "'></a><img class='pe-none user-select-none' src='https://icons.wowdb.com/retail/large/" + data + ".jpg'></div>");
		 			Tooltip.refresh();
		 		});
		 	});
	 	}
