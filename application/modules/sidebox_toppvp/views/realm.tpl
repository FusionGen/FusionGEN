	...
	<tr>
		...
		<td class="col-2">
			<div class="char-raceclass">
				<img align="absbottom" src="{$url}application/assets/images/stats/{$character.race}-{$character.gender}.gif">
				<img align="absbottom" src="{$url}application/assets/images/stats/{$character.class}.gif">
			</div>
		</td>
