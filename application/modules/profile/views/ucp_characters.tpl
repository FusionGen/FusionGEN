				...
				<table class="nice_table mb-3">
					...
					<tbody>
						{foreach from=$realm->getCharacters()->getCharactersByAccount($id) item=character}
							<tr>
								<td class="col-1">
									<img src="{$url}application/assets/images/stats/{$character.race}-{$character.gender}.gif" class="pe-none user-select-none">
								</td>
								<td class="col-2">
									<img src="{$url}application/assets/images/stats/{$character.class}.gif" class="pe-none user-select-none">
								</td>
