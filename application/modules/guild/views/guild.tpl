				...
				<table class="table text-nowrap nice_table">
					...
					<tr>
                        {if $leader}
                            ...
                            <td><img src="{$url}application/assets/images/stats/{$leader.raceId}-{$leader.gender}.gif" class="pe-none user-select-none"></td>
                            <td><img src="{$url}application/assets/images/stats/{$leader.classId}.gif" class="pe-none user-select-none"></td>
                            <td><img src="{$url}application/assets/images/factions/{$leader.faction}.png" width="18" class="pe-none user-select-none"></td>
                            <td>{$leader.level}</td>
						...
						{if $members}
							{foreach from=$members item=character}
								...
								<tr>
									...
									<td><img src="{$url}application/assets/images/stats/{$character.raceId}-{$character.gender}.gif" class="pe-none user-select-none"></td>
									<td><img src="{$url}application/assets/images/stats/{$character.classId}.gif" class="pe-none user-select-none"></td>
									<td><img src="{$url}application/assets/images/factions/{$character.faction}.png" width="18" class="pe-none user-select-none"></td>
