...
class News extends MX_Controller
{
    ...
    public function view($id = null)
    {
        ...
        if ($cache !== false) {
            ...
            foreach ($this->news_articles as $key => $article) {
                ...
                $this->news_articles[$key]['date'] = date("F j, Y", $article['timestamp']);
    ...
    private function getNews()
    {
        ...
        $this->news_articles = $this->news_model->getArticles((int)$this->startIndex, $config['per_page']);
    ...
    private function initPagination()
    {
        ...
        $config['cur_tag_open'] = '<li class="page-item active"><a class="page-link" aria-current="page">';
