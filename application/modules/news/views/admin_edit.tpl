				...
				<div class="tab-content" style="background-color: transparent;">
					<div class="tab-pane active" id="article_en">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_en" class="form-control tinymce_en" id="description_en" cols="30" rows="10">{$article.content_en}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_de">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_de" class="form-control tinymce_de" id="description_de" cols="30" rows="10">{$article.content_de}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_es">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_es" class="form-control tinymce_es" id="description_es" cols="30" rows="10">{$article.content_es}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_fr">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_fr" class="form-control tinymce_fr" id="description_fr" cols="30" rows="10">{$article.content_fr}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_no">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_no" class="form-control tinymce_no" id="description_no" cols="30" rows="10">{$article.content_no}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_ro">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_ro" class="form-control tinymce_ro" id="description_ro" cols="30" rows="10">{$article.content_ro}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_se">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_se" class="form-control tinymce_se" id="description_se" cols="30" rows="10">{$article.content_se}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_ru">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_ru" class="form-control tinymce_ru" id="description_ru" cols="30" rows="10">{$article.content_ru}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_zh">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_zh" class="form-control tinymce_zh" id="description_zh" cols="30" rows="10">{$article.content_zh}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="article_ko">
						...
						<div class="form-group row mb-3">
							...
							<div class="col-sm-10">
								<textarea name="description_ko" class="form-control tinymce_ko" id="description_ko" cols="30" rows="10">{$article.content_ko}</textarea>
							</div>
						</div>
					</div>
				</div>
