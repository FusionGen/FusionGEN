...
<div class="row">
	...
	{if $online}
		...
		<input class="nice_button rounded" type="submit" value="{lang("submit", "news")}" id="comment_button_{$id}">
	{else}
		<textarea disabled placeholder="{lang("log_in", "news")}"></textarea>
		<input class="nice_button rounded" type="submit" value="{lang("submit", "news")}">
	{/if}
	</div>
</div>
</form>
