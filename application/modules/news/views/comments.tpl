			...
			<div class="col-md-12 col-lg-8">
				<div class="Comment-head">
					<div class="Comment-title text-ellipsis">
						<strong><a href="{$url}profile/{$comment.author_id}">{if $comment.is_gm}<img src="{$url}application/assets/images/icons/icon_blizzard.gif" align="absmiddle" style="border:none !important;margin-right:0px !important;box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;">&nbsp;{/if} {$comment.author}</a></strong>
