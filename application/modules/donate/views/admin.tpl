	...
	<div class="card" id="donate_articles">
		...
		<form style="margin-top:0px;" onSubmit="Donate.search('paypal'); return false">
			<div class="input-group mb-3">
				<input class="form-control" type="search" name="search_paypal" id="search_paypal" placeholder="Search by username, E-Mail or Payment ID">
						...
						<tr id="paypal_id_{$paypal_log.id}">
							...
							<td class="text-center" width="15%">
                                {if $paypal_log.status == 0}
                                    <span class="text-default" data-bs-toggle="tooltip" title="Ongoing"><i class="fa-regular fa-circle-check fa-xl"></i></span>
                                ...
                                {elseif $paypal_log.status == 2}
                                    <span class="text-dark" data-bs-toggle="tooltip" title="Canceled"><i class="fa-regular fa-circle-check fa-xl"></i></span>
                                {elseif $paypal_log.status == 3}
                                    <span class="text-danger" data-bs-toggle="tooltip" title="Error"><i class="fa-regular fa-circle-check fa-xl"></i></span>
                                {/if}
                            </td>
						</tr>
					{/foreach}
