...
$emulators = array(
    ...
    "azerothcore_shp_soap" => "(SHP) AzerothCore (3.3.5a) - connected through SOAP",
    ...
    "trinity_legion_soap" => "(SHP) TrinityCore - Legion (7.x.x) - connected through SOAP",
    "cmangos_soap" => "(HEX) CMangos (3.3.5a) - connected through SOAP",
    "mop_soap" => "(SHP) MoP (5.4.8) - connected through SOAP",
);
