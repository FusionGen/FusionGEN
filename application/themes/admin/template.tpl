...
<html>
	<head>
		...
		<script src="{if $cdn}https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.3/html5shiv.js{else}{$path}js/html5shiv.js{/if}"></script>
		<script type="text/javascript" src="{if $cdn}https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js{else}{$path}js/jquery.min.js{/if}"></script>
