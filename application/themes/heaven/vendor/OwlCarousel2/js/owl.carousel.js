	...
	Animate.prototype.swap = function() {
		...
		var left,
			...
			if(incoming.constructor == Array) {
				this.core.settings.lastAnimation = Math.floor(Math.random() * incoming.length);
				this.core.settings.lengthIncoming = incoming.length;
				incoming = incoming[this.core.settings.lastAnimation];
			}

			if(outgoing.constructor == Array) {
				if(this.core.settings.lengthIncoming <= outgoing.length || this.core.settings.lengthIncoming == outgoing.length) {
					outgoing = outgoing[this.core.settings.lastAnimation];
				}
			}
