...
<section class="realmlist-info box">
	<div class="body">
		<div class="realmlist">SET portal "{$realmlist}"&nbsp;&nbsp;<i data-tip="Copy to clipboard" style="color:white; cursor:pointer;" onclick="copyToClipboard()" class="far fa-copy"></i></div>
