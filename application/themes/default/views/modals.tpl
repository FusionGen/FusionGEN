				...
				<div class="captcha-field2 {if !$use_captcha && $captcha_type == 'inbuilt'}d-none{/if}">
					<div class="input-group mt-3">
						...
						<div class="form-floating ms-0 flex-grow-1">
							<input type="text" class="form-control captcha-input2 border-0 rounded-0 rounded-bottom-end" id="floatingCaptcha2" placeholder="Captcha" aria-describedby="captcha" {if $use_captcha}required{/if}>
...
<!-- Confirm box -->
<div id="confirm" class="popup-box confirm-box v-center popup-login d-none">
...
<!-- Alert box -->
<div id="alert" class="popup-box alert-box v-center d-none">
