...
<html lang="zxx">
	<head>
		...
		<meta property="og:image" content="{$url}application/assets/images/misc/preview-thumbnail.png">
		...
		<link rel="stylesheet" href="{$url}application/assets/css/default.css">
		<link rel="stylesheet" href="{$url}application/assets/css/tooltip.css">
		...
		<script src="{if $cdn_link}{$cdn_link}{else}{$url}{/if}application/assets/js/jquery.sort.js"></script>
		...
		<script src="{if $cdn_link}{$cdn_link}{else}{$url}{/if}application/assets/js/cookie.js"></script>
