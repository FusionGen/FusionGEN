...
class AscEmu implements Emulator
{
	private $config;
	...
	private $queries = array(
		...
		"get_account_id" => "SELECT acct id, login username, encrypted_password password, email email, lastlogin joindate, lastip last_ip, lastlogin last_login, flags expansion FROM accounts WHERE acct = ?",
		"get_account" => "SELECT acct id, login username, encrypted_password password, email email, lastlogin joindate, lastip last_ip, lastlogin last_login, flags expansion FROM accounts WHERE login = ?",
