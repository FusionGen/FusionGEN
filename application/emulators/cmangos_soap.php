...
class Cmangos_soap implements Emulator
{
    ...
    */
    ...
    protected $queries = array(
        ...
        'get_account_id'            => 'SELECT a.id id, a.username username, a.v password, a.email email, a.joindate joindate, b.ip last_ip, b.loginTime last_login, a.expansion expansion FROM account a LEFT JOIN account_logons b ON b.accountId = a.id WHERE a.id = ?',
        'get_account'               => 'SELECT a.id id, a.username username, a.v password, a.email email, a.joindate joindate, b.ip last_ip, b.loginTime last_login, a.expansion expansion FROM account a LEFT JOIN account_logons b ON b.accountId = a.id WHERE a.username = ?',
